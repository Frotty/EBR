...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem( 'I008', 4867.9, -6777.6 )
    call CreateItem( 'I009', 3469.9, -7039.9 )
    call CreateItem( 'I009', -2696.9, -4345.6 )
    call CreateItem( 'I009', -3591.5, -5889.7 )
    call CreateItem( 'I009', -1866.6, -6296.8 )
    call CreateItem( 'I009', -4731.9, -6904.0 )
    call CreateItem( 'I009', 1549.5, -5746.7 )
    call CreateItem( 'I00A', -1202.3, -6407.8 )
    ...
    call CreateItem( 'I00A', -3536.7, -5886.7 )
    call CreateItem( 'I00A', -3486.1, -4977.5 )
    call CreateItem( 'I00A', -1280.7, -4227.1 )
    call CreateItem( 'I00A', 3824.7, -6470.1 )
    call CreateItem( 'I00A', -2662.9, -6508.9 )
    call CreateItem( 'I00A', 2419.0, -5207.0 )
    call CreateItem( 'I00J', 6735.7, -7105.2 )
    call CreateItem( 'I010', -4180.2, -5155.2 )
    call CreateItem( 'I010', 3834.1, -6388.5 )
    call CreateItem( 'I010', 2587.9, -7198.0 )
    call CreateItem( 'I010', 3857.3, -6610.9 )
    call CreateItem( 'I010', 2393.1, -5257.3 )
    call CreateItem( 'I010', 2453.3, -5252.1 )
    call CreateItem( 'I010', -147.9, -3929.0 )
    call CreateItem( 'I010', -1302.0, -4284.5 )
    call CreateItem( 'I010', -1245.9, -4207.5 )
    call CreateItem( 'I010', 3825.0, -6017.5 )
    call CreateItem( 'I010', -4253.4, -6511.4 )
    call CreateItem( 'I010', -2328.8, -4286.8 )
    call CreateItem( 'I010', -3958.8, -6266.4 )
    call CreateItem( 'I010', -1935.6, -3928.7 )
    call CreateItem( 'I010', -1142.1, -6392.7 )
    call CreateItem( 'I010', 132.5, -4618.8 )
    ...
    call CreateItem( 'I010', 4734.6, -6775.5 )
    call CreateItem( 'I010', 4387.1, -4166.0 )
    call CreateItem( 'I010', 1533.9, -5637.5 )
    call CreateItem( 'I010', -1272.9, -6401.0 )
    ...
    call CreateItem( 'I010', -1929.1, -3851.7 )
    call CreateItem( 'I010', -2302.7, -4229.0 )
    call CreateItem( 'I010', -147.8, -4619.9 )
    call CreateItem( 'I010', -4211.2, -6531.3 )
    call CreateItem( 'I010', 1652.8, -5772.4 )
    call CreateItem( 'I010', 4964.5, -6771.4 )
    call CreateItem( 'I010', -2535.3, -5737.3 )
    call CreateItem( 'I010', -2558.1, -5797.3 )
    call CreateItem( 'I010', -2400.4, -5515.1 )
    call CreateItem( 'I010', -2477.1, -5544.9 )
    call CreateItem( 'I010', 150.1, -4362.8 )
    call CreateItem( 'I010', -151.9, -4331.0 )
endfunction
...
function CreateBuildingsForPlayer8 takes nothing returns nothing
    ...
    set gg_unit_tele_0058 = CreateUnit( p, 'tele', -6400.0, -5184.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer9 takes nothing returns nothing
    ...
    set gg_unit_tele_0063 = CreateUnit( p, 'tele', -6144.0, -5184.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer10 takes nothing returns nothing
    ...
    set gg_unit_tele_0115 = CreateUnit( p, 'tele', -5888.0, -5184.0, 270.000 )
endfunction
...
function CreateBuildingsForPlayer11 takes nothing returns nothing
    ...
    set gg_unit_tele_0143 = CreateUnit( p, 'tele', -5632.0, -5184.0, 270.000 )
endfunction
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'boic', 4608.0, -6976.0, 270.000 )
    set u = CreateUnit( p, 'boic', 6528.0, -7232.0, 270.000 )
    ...
    set u = CreateUnit( p, 'soic', 6656.0, -6912.0, 270.000 )
    set gg_unit_dor2_0011 = CreateUnit( p, 'dor2', 5440.0, -5568.0, 270.000 )
    set u = CreateUnit( p, 'soic', 5376.0, -4800.0, 270.000 )
    ...
    set u = CreateUnit( p, 'boic', 6592.0, -7104.0, 270.000 )
    set gg_unit_revp_0022 = CreateUnit( p, 'revp', 512.0, -6912.0, 270.000 )
    set gg_unit_dor2_0023 = CreateUnit( p, 'dor2', 6336.0, -6592.0, 270.000 )
    set u = CreateUnit( p, 'dor2', 0.0, -4736.0, 270.000 )
    set u = CreateUnit( p, 'boic', 5376.0, -4608.0, 270.000 )
    set u = CreateUnit( p, 'boic', 5760.0, -4864.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3776.0, -6784.0, 270.000 )
    ...
    set u = CreateUnit( p, 'soic', 4992.0, -4096.0, 270.000 )
    ...
    set u = CreateUnit( p, 'sogr', 0.0, -5760.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 256.0, -5504.0, 270.000 )
    set u = CreateUnit( p, 'bogr', -1024.0, -6400.0, 270.000 )
    set gg_unit_arca_0050 = CreateUnit( p, 'arca', 0.0, -5056.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 192.0, -4288.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 0.0, -5248.0, 270.000 )
    set u = CreateUnit( p, 'boic', 2176.0, -4160.0, 270.000 )
    ...
    set u = CreateUnit( p, 'boic', 1984.0, -5824.0, 270.000 )
    set u = CreateUnit( p, 'boic', 1408.0, -5568.0, 270.000 )
    set gg_unit_fnt2_0074 = CreateUnit( p, 'fnt2', 3328.0, -5952.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 2304.0, -5888.0, 270.000 )
    ...
    set u = CreateUnit( p, 'n00X', 2432.0, -5888.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 2304.0, -6400.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 1984.0, -6272.0, 270.000 )
    ...
    set u = CreateUnit( p, 'boic', 6656.0, -6976.0, 270.000 )
    set u = CreateUnit( p, 'soic', 6528.0, -7168.0, 270.000 )
    set u = CreateUnit( p, 'boic', 5760.0, -5312.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 2176.0, -6080.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 2240.0, -6144.0, 270.000 )
    ...
    set u = CreateUnit( p, 'soic', 2048.0, -4160.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 1408.0, -4608.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 3392.0, -5184.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 2432.0, -6080.0, 270.000 )
    ...
    set u = CreateUnit( p, 'n00X', 2496.0, -6144.0, 270.000 )
    ...
    set u = CreateUnit( p, 'boic', 2048.0, -4160.0, 270.000 )
    set u = CreateUnit( p, 'boic', 1920.0, -4224.0, 270.000 )
    ...
    set gg_unit_tele_0150 = CreateUnit( p, 'tele', -6656.0, -5760.0, 270.000 )
    set gg_unit_jump_0151 = CreateUnit( p, 'jump', 3328.0, -6272.0, 270.000 )
    set gg_unit_jump_0152 = CreateUnit( p, 'jump', 3456.0, -6528.0, 270.000 )
    ...
    set u = CreateUnit( p, 'soct', -4032.0, -6656.0, 270.000 )
    set u = CreateUnit( p, 'boct', -2752.0, -6464.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3392.0, -6912.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3584.0, -6848.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3328.0, -7040.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3520.0, -7168.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3520.0, -7040.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3328.0, -7168.0, 270.000 )
    set u = CreateUnit( p, 'dor2', -2496.0, -4864.0, 270.000 )
    set u = CreateUnit( p, 'bogr', -384.0, -6592.0, 270.000 )
    ...
    set u = CreateUnit( p, 'hogr', 128.0, -5632.0, 270.000 )
    ...
    set u = CreateUnit( p, 'sogr', -128.0, -6336.0, 270.000 )
    ...
    set u = CreateUnit( p, 'soct', -2624.0, -6976.0, 270.000 )
    ...
    set u = CreateUnit( p, 'boic', 5056.0, -6720.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3264.0, -7104.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3456.0, -6784.0, 270.000 )
    set u = CreateUnit( p, 'soct', -2880.0, -6976.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3968.0, -6528.0, 270.000 )
    ...
    set u = CreateUnit( p, 'boic', -5760.0, -6912.0, 270.000 )
    set u = CreateUnit( p, 'boic', -6016.0, -6912.0, 270.000 )
    set u = CreateUnit( p, 'boic', -6016.0, -6656.0, 270.000 )
    set u = CreateUnit( p, 'boic', 5952.0, -6208.0, 270.000 )
    set u = CreateUnit( p, 'boic', -6272.0, -6912.0, 270.000 )
    set gg_unit_revp_0322 = CreateUnit( p, 'revp', -6016.0, -5760.0, 270.000 )
    set gg_unit_tele_0323 = CreateUnit( p, 'tele', -5248.0, -5632.0, 270.000 )
    set gg_unit_tele_0324 = CreateUnit( p, 'tele', -5248.0, -5888.0, 270.000 )
    set u = CreateUnit( p, 'soct', -4608.0, -6848.0, 270.000 )
    set u = CreateUnit( p, 'boic', -6016.0, -7168.0, 270.000 )
    set u = CreateUnit( p, 'soic', -6528.0, -6912.0, 270.000 )
    set u = CreateUnit( p, 'soic', 4288.0, -6912.0, 270.000 )
    set u = CreateUnit( p, 'soic', -6528.0, -7104.0, 270.000 )
    set u = CreateUnit( p, 'boic', 704.0, 7232.0, 270.000 )
    set u = CreateUnit( p, 'soic', -6400.0, -6784.0, 270.000 )
    set u = CreateUnit( p, 'boic', 704.0, 7872.0, 270.000 )
    set u = CreateUnit( p, 'boic', -1600.0, 7872.0, 270.000 )
    set u = CreateUnit( p, 'boic', -1600.0, 7232.0, 270.000 )
    set u = CreateUnit( p, 'boic', -448.0, 7872.0, 270.000 )
    set u = CreateUnit( p, 'boic', -448.0, 7232.0, 270.000 )
    set u = CreateUnit( p, 'boic', 4672.0, -6336.0, 270.000 )
    set u = CreateUnit( p, 'boic', 1600.0, -4736.0, 270.000 )
    set u = CreateUnit( p, 'soic', 1600.0, -4608.0, 270.000 )
    set u = CreateUnit( p, 'boic', 5056.0, -6208.0, 270.000 )
    set u = CreateUnit( p, 'soic', 6464.0, -6720.0, 270.000 )
    set u = CreateUnit( p, 'soic', 6400.0, -6784.0, 270.000 )
    set u = CreateUnit( p, 'soic', 1920.0, -4224.0, 270.000 )
    set u = CreateUnit( p, 'soct', -3648.0, -6272.0, 270.000 )
    set u = CreateUnit( p, 'boic', 6400.0, -6848.0, 270.000 )
    set u = CreateUnit( p, 'soic', 6400.0, -6976.0, 270.000 )
    set u = CreateUnit( p, 'soic', 6400.0, -6912.0, 270.000 )
    set u = CreateUnit( p, 'boic', 6208.0, -6272.0, 270.000 )
    set u = CreateUnit( p, 'soic', 6272.0, -6272.0, 270.000 )
    set u = CreateUnit( p, 'boic', 6720.0, -6016.0, 270.000 )
    set u = CreateUnit( p, 'boic', 6592.0, -5440.0, 270.000 )
    set u = CreateUnit( p, 'boic', 4480.0, -5632.0, 270.000 )
    set u = CreateUnit( p, 'soic', 5056.0, -4992.0, 270.000 )
    set u = CreateUnit( p, 'boic', 5376.0, -4736.0, 270.000 )
    set u = CreateUnit( p, 'boic', 5248.0, -3840.0, 270.000 )
    set u = CreateUnit( p, 'boic', 1728.0, -3968.0, 270.000 )
    set u = CreateUnit( p, 'boic', 1600.0, -3904.0, 270.000 )
    set u = CreateUnit( p, 'soic', 1664.0, -3968.0, 270.000 )
    set u = CreateUnit( p, 'soic', 1600.0, -3840.0, 270.000 )
    set u = CreateUnit( p, 'boic', 1408.0, -4416.0, 270.000 )
    set u = CreateUnit( p, 'boic', 2304.0, -4864.0, 270.000 )
    set u = CreateUnit( p, 'boic', 1536.0, -5504.0, 270.000 )
    set u = CreateUnit( p, 'soic', 1600.0, -5568.0, 270.000 )
    set u = CreateUnit( p, 'soic', 1600.0, -5504.0, 270.000 )
    set u = CreateUnit( p, 'soic', 1408.0, -5504.0, 270.000 )
    set u = CreateUnit( p, 'arca', -128.0, -5120.0, 270.000 )
    set u = CreateUnit( p, 'arca', -128.0, -5248.0, 270.000 )
    set u = CreateUnit( p, 'arca', 128.0, -5120.0, 270.000 )
    set u = CreateUnit( p, 'arca', 128.0, -5248.0, 270.000 )
    set u = CreateUnit( p, 'arca', 0.0, -4928.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -128.0, -6400.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -128.0, -6464.0, 270.000 )
    set u = CreateUnit( p, 'bogr', 128.0, -6464.0, 270.000 )
    set u = CreateUnit( p, 'bogr', -448.0, -6272.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -960.0, -7168.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -896.0, -6848.0, 270.000 )
    set u = CreateUnit( p, 'arca', 256.0, -4480.0, 270.000 )
    set u = CreateUnit( p, 'arca', 384.0, -4480.0, 270.000 )
    set u = CreateUnit( p, 'arca', 512.0, -4480.0, 270.000 )
    set u = CreateUnit( p, 'arca', 640.0, -4480.0, 270.000 )
    set u = CreateUnit( p, 'arca', 768.0, -4480.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 320.0, -4352.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 384.0, -4352.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 448.0, -4352.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 512.0, -4352.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 576.0, -4352.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 320.0, -4608.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 384.0, -4544.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 448.0, -4544.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 512.0, -4544.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 576.0, -4608.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 640.0, -4352.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 768.0, -4352.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 640.0, -4608.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 640.0, -4736.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 256.0, -4608.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 256.0, -4736.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 256.0, -4352.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 256.0, -4288.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 128.0, -4224.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -1280.0, -5440.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -1280.0, -5568.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -1216.0, -5504.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -1152.0, -5632.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -1152.0, -5568.0, 270.000 )
    set u = CreateUnit( p, 'sogr', -1216.0, -5696.0, 270.000 )
    set u = CreateUnit( p, 'fnt2', 2240.0, -6528.0, 270.000 )
    set u = CreateUnit( p, 'n00X', 2112.0, -6336.0, 270.000 )
    set u = CreateUnit( p, 'hogr', 384.0, -5632.0, 270.000 )
    set u = CreateUnit( p, 'hogr', -128.0, -5632.0, 270.000 )
    set u = CreateUnit( p, 'sogr', 0.0, -5184.0, 270.000 )
    set u = CreateUnit( p, 'soct', -2816.0, -6592.0, 270.000 )
    set u = CreateUnit( p, 'soct', -2752.0, -6464.0, 270.000 )
    set u = CreateUnit( p, 'soct', -2560.0, -6976.0, 270.000 )
    set u = CreateUnit( p, 'soct', -2496.0, -6976.0, 270.000 )
endfunction
...
function CreateNeutralPassive takes nothing returns nothing
    ...
    set gg_unit_sick_0013 = CreateUnit( p, 'sick', 5302.9, -6244.3, 214.330 )
    set gg_unit_sick_0014 = CreateUnit( p, 'sick', 5150.6, -6244.3, 214.330 )
    set gg_unit_bisk_0018 = CreateUnit( p, 'bisk', 6687.5, -6065.3, 151.979 )
    set gg_unit_bisk_0020 = CreateUnit( p, 'bisk', 5711.5, -5098.9, 232.972 )
    set gg_unit_knck_0033 = CreateUnit( p, 'knck', 6229.0, -3870.0, 167.030 )
    set gg_unit_knck_0034 = CreateUnit( p, 'knck', 5101.7, -4444.1, 106.560 )
    set gg_unit_sick_0036 = CreateUnit( p, 'sick', 4334.4, -5872.7, 214.330 )
    set gg_unit_sgrk_0038 = CreateUnit( p, 'sgrk', -124.0, -4804.8, 271.648 )
    set gg_unit_sgrk_0039 = CreateUnit( p, 'sgrk', 118.5, -4815.4, 269.562 )
    ...
    set gg_unit_ssak_0124 = CreateUnit( p, 'ssak', 3820.3, -6813.3, 11.701 )
    set gg_unit_ssak_0125 = CreateUnit( p, 'ssak', 3074.3, -6143.2, 11.701 )
    set gg_unit_bsak_0127 = CreateUnit( p, 'bsak', 3682.5, -6428.9, 15.293 )
    set gg_unit_bsak_0128 = CreateUnit( p, 'bsak', 3599.9, -6896.9, 221.118 )
    set gg_unit_spnr_0129 = CreateUnit( p, 'spnr', -2568.0, -7165.5, 279.281 )
    set gg_unit_spnr_0130 = CreateUnit( p, 'spnr', -2812.7, -6659.0, 9.635 )
    ...
    set gg_unit_sgrk_0153 = CreateUnit( p, 'sgrk', -276.7, -5498.4, 356.673 )
    set gg_unit_glve_0156 = CreateUnit( p, 'glve', -2298.9, -7174.0, 305.445 )
    set gg_unit_spnr_0157 = CreateUnit( p, 'spnr', -3003.3, -5331.1, 71.897 )
    set gg_unit_glve_0158 = CreateUnit( p, 'glve', -2868.2, -6868.9, 160.548 )
    set gg_unit_glve_0159 = CreateUnit( p, 'glve', -2663.1, -6633.9, 160.548 )
    set gg_unit_glve_0160 = CreateUnit( p, 'glve', -2828.3, -6698.8, 160.548 )
    ...
    set gg_unit_scik_0210 = CreateUnit( p, 'scik', -4223.3, -6896.7, 228.358 )
    set gg_unit_scik_0211 = CreateUnit( p, 'scik', -4231.1, -7047.3, 228.358 )
    set gg_unit_scik_0213 = CreateUnit( p, 'scik', -2314.0, -5244.7, 136.430 )
    set gg_unit_scik_0214 = CreateUnit( p, 'scik', -2291.0, -5374.2, 136.430 )
    set gg_unit_scik_0215 = CreateUnit( p, 'scik', -3175.3, -4461.5, 88.805 )
    call SetUnitState( gg_unit_scik_0215, UNIT_STATE_MANA, 0 )
    set gg_unit_scik_0216 = CreateUnit( p, 'scik', -3278.2, -4652.1, 176.970 )
    call SetUnitState( gg_unit_scik_0216, UNIT_STATE_MANA, 0 )
    set gg_unit_scik_0217 = CreateUnit( p, 'scik', -2974.3, -4709.1, 11.117 )
    call SetUnitState( gg_unit_scik_0217, UNIT_STATE_MANA, 0 )
    set gg_unit_scik_0218 = CreateUnit( p, 'scik', -4730.5, -6657.7, 228.358 )
    set gg_unit_scik_0219 = CreateUnit( p, 'scik', -4227.5, -7194.6, 228.358 )
    set gg_unit_bcik_0220 = CreateUnit( p, 'bcik', -2689.3, -4154.3, 173.698 )
    call SetUnitState( gg_unit_bcik_0220, UNIT_STATE_MANA, 0 )
    set gg_unit_scik_0221 = CreateUnit( p, 'scik', -4708.8, -5117.0, 214.220 )
    set gg_unit_scik_0222 = CreateUnit( p, 'scik', -4898.9, -5499.6, 214.220 )
    set gg_unit_bcik_0225 = CreateUnit( p, 'bcik', -4128.7, -4544.5, 117.546 )
    set gg_unit_scik_0260 = CreateUnit( p, 'scik', -3855.1, -6773.1, 275.361 )
    set gg_unit_scik_0261 = CreateUnit( p, 'scik', -3893.9, -6569.4, 93.847 )
    set gg_unit_bcik_0262 = CreateUnit( p, 'bcik', -3563.7, -6527.4, 73.303 )
    set gg_unit_scik_0263 = CreateUnit( p, 'scik', -3013.2, -6283.2, 0.670 )
    set gg_unit_bcik_0266 = CreateUnit( p, 'bcik', -3701.0, -7187.8, 49.209 )
    set gg_unit_scik_0267 = CreateUnit( p, 'scik', -4409.7, -6029.0, 114.569 )
    set gg_unit_scik_0268 = CreateUnit( p, 'scik', -3473.7, -5753.8, 315.779 )
    ...
    set gg_unit_scik_0271 = CreateUnit( p, 'scik', -3062.3, -5408.0, 41.036 )
    call SetUnitState( gg_unit_scik_0271, UNIT_STATE_MANA, 0 )
    set gg_unit_scik_0272 = CreateUnit( p, 'scik', -2819.8, -5516.3, 42.306 )
    call SetUnitState( gg_unit_scik_0272, UNIT_STATE_MANA, 0 )
    set gg_unit_scik_0273 = CreateUnit( p, 'scik', -3194.4, -5523.4, 44.570 )
    ...
    set gg_unit_scik_0276 = CreateUnit( p, 'scik', -2768.3, -5579.5, 45.251 )
    call SetUnitState( gg_unit_scik_0276, UNIT_STATE_MANA, 0 )
    set gg_unit_scik_0277 = CreateUnit( p, 'scik', -2935.2, -5294.8, 224.828 )
    call SetUnitState( gg_unit_scik_0277, UNIT_STATE_MANA, 0 )
    set gg_unit_scik_0278 = CreateUnit( p, 'scik', -2979.2, -5329.6, 222.822 )
    call SetUnitState( gg_unit_scik_0278, UNIT_STATE_MANA, 0 )
    set gg_unit_bcik_0280 = CreateUnit( p, 'bcik', -3406.0, -5248.3, 117.546 )
endfunction
